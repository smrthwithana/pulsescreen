# pulsescreen / BeatBridge

BeatBridge is a full-screen old-school MP3 visualizer for live microphone audio. It draws liquid neon lines, beat-reactive particles, and equalizer waves, then overlays the current playback state and smooth transition recommendations.
...
```powershell
git remote add origin https://github.com/YOUR_USERNAME/pulsescreen.git
git branch -M main
